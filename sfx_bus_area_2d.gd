...
@export var target_bus_name: String = "" # Bus when player enters the area
var previous_bus_name: String = "SFX" # Default bus when player exits the area
...
func _on_body_entered(_body: Node2D) -> void:
	...
	if AudioManager:		previous_bus_name = AudioManager.get_current_sfx_bus_name()
